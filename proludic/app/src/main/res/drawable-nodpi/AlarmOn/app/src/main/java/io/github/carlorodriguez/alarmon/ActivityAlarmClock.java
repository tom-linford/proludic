...
public final class ActivityAlarmClock extends AppCompatActivity implements
    ...
    public ActivityAlarmClock activityAlarmClock;
    ...
    private void checkRunType() {
        ...
        String type = utils.checkFirstRun(context);
        switch (type) {
            case FIRST_RUN:
    ...
    private void initToolbar() {
        ...
        final FrameLayout homeTimerContainer = (FrameLayout) collapsingToolbarLayout.findViewById(R.id.home_timer_container);
            ...
            public void onStateChanged(AppBarLayout appBarLayout, State state) {
                switch (state) {
                    case EXPANDED:
                        ...
                        homeTimerContainer.setVisibility(View.VISIBLE);
                        break;
                    case COLLAPSED:
                        logo.setVisibility(View.VISIBLE);
//                        homeTimerContainer.setVisibility(View.GONE);
                        break;
                }
            }
        });
    ...
    private void redraw() {
        ...
        toolbarTitle.setText(time.localizedString(this, false));
    }
    ...
    public void setEmptyViewIfEmpty(Activity activity) {
    ...
    public void removeItemFromList(Activity activity, long alarmId, int position) {
