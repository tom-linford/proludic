...
public final class AppSettings {
  ...
  public static String lockScreenString(Context c, AlarmTime nextTime) {
    ...
    String countdown = "";
    if (nextTime != null) {
      time = nextTime.localizedString(c, false);
  ...
  public static int alarmTimeOutMins(Context c) {
    ...
    public static void setMainActivityTheme(Context context, Activity activity) {
        activity.setTheme(R.style.MainAppThemeDark);
    }
    ...
    public static int getTimePickerColor(Context context) {
        ...
        String color = sharedPref.getString(TIME_PICKER_COLOR, "orange");
        ...
        switch (color) {
            ...
            case "blue-grey":
                ...
                break;
            case "teal":
                pickerColor = Integer.toHexString(ContextCompat.getColor(context, R.color.teal));
                break;
            default:
                pickerColor = Integer.toHexString(ContextCompat.getColor(context,
                                R.color.orange));
